...
<div class="container-fluid">
	<form id="manage_book">
		<div class="col-md-12">
			...
			<div class="form-group mb-2">
				<label for="qty" class="control-label">Mail</label>
				<input type="text" maxlength="50" class="form-control text-right" id="mail" name="mail" value="<?php echo isset($bmeta['mail']) ? $bmeta['mail'] : '' ?>">
			</div>
			<?php if(isset($_SESSION['login_id'])): ?>
			<div class="form-group mb-2">
				<label for="qty" class="control-label">Status</label>
				<select  class="form-control" id="status" name="status" value="<?php echo isset($bmeta['mail']) ? $bmeta['mail'] : '' ?>">
